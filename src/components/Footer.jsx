        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 text-center md:text-left">
          ...
          <div>
            ...
            <p className="text-gray-300 mt-2 text-xs md:text-sm max-w-xs mx-auto md:mx-0">
              We help you grow online with modern, scalable, and beautiful
              solutions.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 items-center md:items-start">
            ...
            >
              <div className="p-1.5 bg-white/20 rounded-full text-white group-hover:bg-white group-hover:text-blue-700 transition-colors">
            ...
            >
              <div className="p-1.5 bg-white/20 rounded-full text-white group-hover:bg-white group-hover:text-pink-700 transition-colors">
